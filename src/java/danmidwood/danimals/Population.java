...
public class Population extends AbstractTableModel implements Cloneable, java.util.Map
{
    ...
    /**
     * Construct a clone of the Environment passed. All variables and the map
    ...
    /**
     * A method to return a clone of the Environment.
     ...
     * any BitString will be reflected in both Environments.
