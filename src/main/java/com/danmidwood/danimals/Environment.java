...
public class Environment
{
    ...
    public void addActionListener(ActionListener al) { listeners.add((Class<ActionListener>) al.getClass(), al); }
    public void removeActionListener(ActionListener al) { listeners.remove((Class<ActionListener>) al.getClass(), al); }
