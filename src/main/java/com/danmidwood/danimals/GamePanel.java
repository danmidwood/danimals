...
public class GamePanel extends Box implements GameModel, ActionListener
{
    ...
    public void addActionListener(ActionListener l) { if (listening == null) listening = l; }
    public void removeActionListener() { listening = null; }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src == initialize) {
            ...
            if (listening != null) listening.actionPerformed(new ActionEvent(this, ActionEvent.ACTION_PERFORMED, "com.danmidwood.danimals.Game is ready"));
            gameDefined = true;
            gd.hide(); }
        else { System.out.println(src.toString() + " " + gd.toString()); define.setVisible(false); }
    }
    ...
    public void setName(String newName) { game.setName(newName); }
    public String getName() { return game.getName(); }    
    public boolean ready() { return gameDefined; }
    public java.util.Set unsetValues() { return game.unsetValues(); }    
    public Object addResult(Object key, Result res)throws Exception { return game.addResult(key, res); }
